      ...
      <Form method="POST">
        ...
        <div className="mb-5 flex flex-col gap-2 sm:flex-row sm:items-center">
          ...
          <div className="grow">
            ...
            {actionErrors?.phone && (
              <p className="mt-2 rounded-md bg-red-200 px-4 py-2 text-xs text-red-700">
                {actionErrors.phone}
              </p>
            )}
          </div>
        ...
        <div className="relative mb-5 flex flex-col gap-2 sm:flex-row sm:items-center">
          ...
          <div className="grow">
            ...
            {!position.latitude && !position.longitude && (
              <span className="absolute top-[34px] bottom-[3px] right-[3px] sm:top-[2.5px] md:top-[5px] md:right-[5px]">
                <Button
                  disabled={isLoadingAddress}
                  onClick={(e) => {
                    e.preventDefault();
...
export async function action({ request }) {
  ...
  if (!isValidPhone(order.phone)) {
    errors.phone = 'Please input your number correctly';
  }
